        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="leclog.php">Login</a></li>
                </ul>
            </div>
        </div><!--/.container-->
    </nav><!--/nav-->
...
<section id="feature" >
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <h2>Please login</h2>
                <form  class="form-horizontal" method="POST" action="codes/login.php">
                    <div class="form-group">
                        <label for="inputusername" class="col-sm-2 control-label">Staff NO</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" placeholder="Staff ID" name="staffno"  ?>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <input type="submit" name="lecsubmit" value="Login">
                        </div>
                    </div>
                </form>
