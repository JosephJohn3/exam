            ...
            <div class="col-sm-9">
                ...
                <form action="../codes/query.php" method="post" class="form-horizontal">
                    <div  class="row form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control"  pattern="/[^a-zA-Z -]/" title="ONLY LETTERS ARE REQUIRED" name="firstname" placeholder="Enter Firstname" required>
                        </div>

                        <label for="lame" class="col-sm-2 control-label">Lastname</label>
                        <div class="col-md-4">
                            <input type="text" class="form-control" pattern="('/[^a-zA-Z -]/')"  title="ONLY LETTERS ARE REQUIRED" name="lastname" placeholder="Enter Lastname" required>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="tel" class="form-control" name="telephone"  pattern="^\d{4}-\d{3}-\d{3}$" title="THIS THE FORMAT 0722-123-456" placeholder="Enter Phone No." required>
                        </div>
                    </div>
                    ...
                    <input type="hidden" name="lecsubmit" value="2">
