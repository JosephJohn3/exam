...
<section>
    ...
    <div class="row">
        ...
        ?>
        <div class="col-sm-9">
            <h2>Enter the lecturer to delete</h2>
            <form action="../codes/delete.php" method="POST" class="form-group">
                <div class="form-group">
                    <label for="phone" class="col-sm-2 control-label">The lecturer to delete</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="stafno" placeholder="Enter lecturer number to delete">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-9">
                        <input type="submit" name="deletestaf" value="Click to delete">
                    </div>
                </div>
            </form>
                </div>
