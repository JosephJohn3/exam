        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="adlog.php">Login</a></li>
                </ul>
            </div>
        </div><!--/.container-->
    </nav><!--/nav-->
            ...
            <div class="col-md-10">
                ...
                <form action="codes/login.php" method="POST" class="form-horizontal">
                    <div class="form-group">
                        <label for="inputusername" class="col-sm-2 control-label">Admin ID</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" placeholder="Staff ID" name="stafno"  ?>
                        </div>
                    </div>
                    <div class="form-group">
